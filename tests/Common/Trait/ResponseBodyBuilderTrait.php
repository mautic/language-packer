...
trait ResponseBodyBuilderTrait
{
    ...
    {
        return '{"data":[{"id":"o:mautic:p:mautic:r:'.$resource.':l:'.$language
            .'","attributes":{"last_update":"2015-05-21T08:06:10Z"}}]}';
    }
    ...
    {
        return '{"data":{"id":"'.$uuid.'","attributes":{"status":"'.$status
            .'"},"links":{"self":"https://rest.api.transifex.com/resource_translations_async_downloads/'.$uuid.'"}}}';
    }

    private static function buildIniBody(
        string $ini = 'mautic.addon.notice.reloaded="%added% addons were added, %updated% updated, and %disabled% disabled."'
    ): string {
        return $ini;
    }
}
